...
class ApiRepository {
  Future<PhotoList?> getPhotoList({String text = '', int page = 1, int perPage = 50}) async {
    final apiUrl =
        'https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=5ee9bb983babe659d4a61f33754acc71&text=$text&extras=url_t&per_page=$perPage&page=$page&format=json&nojsoncallback=1';
    try {
